...
export default async function NotFound() {
  ...
  const requestId = headersList.get('x-vercel-id') || 'icn1::local-dev-0000000000000-000000000000'
          ...
          <div className="w-full bg-white/[0.03] border border-white/10 rounded-3xl overflow-hidden backdrop-blur-xl">
             <div className="p-8 text-center space-y-4">
                ...
                <div className="space-y-1">
                   ...
                   <p className="text-[10px] text-zinc-600 font-mono uppercase">ID: {requestId}</p>
                </div>
             </div>
